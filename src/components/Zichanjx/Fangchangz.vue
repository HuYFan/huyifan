<template>
  <div id="all">
    <Header></Header>
    <span class="sp1">房产管理>房产改造</span>
    <div class="div1">
      <span class="sp2">维修改造</span>
      ...
      <template>
        <el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" :header-cell-style="{background:'#D7D7D7',color:'#666666'}" style="font-size:12px;width: 95%;margin-left:34px;margin-top:15px" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="a10" label="改造开始时间" width="65"></el-table-column>
          <el-table-column prop="a11" label="改造结束时间" width="65"></el-table-column>
