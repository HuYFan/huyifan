<template>
  <div id="all">
    <Header></Header>
    <span class="sp1">申请管理>教学设备借入申请</span>
    <div class="div1">
      <span class="sp2">教学设备借入申请记录</span>
      <router-link to="/faqijr" tag="el-button" style="border-radius: 0%;background:#ED5665;color:white;border:none" id="btn1">发起借入申请</router-link>
      ...
      <template>
        <el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" :header-cell-style="{background:'#D7D7D7',color:'#666666'}" style="width: 95%;margin-left:34px;margin-top:15px" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="申请时间" width="230"><template slot-scope="scope">{{ scope.row.date }}</template></el-table-column>
          <el-table-column prop="name" label="借入物品" width="230"></el-table-column>
          <el-table-column prop="bianma" label="预计归还时间" width="230"></el-table-column>
          <el-table-column prop="shif" label="审批状态" width="230"></el-table-column>
          <el-table-column prop="caoz" label="操作" width="234"></el-table-column>
        </el-table>
      </template>
      <el-button type="text" @click="dialogVisible = true" style="color:#606266;position:absolute;top:257px;left:1103px;opacity:0">查看详情</el-button>
      <el-dialog title="申请详情" :visible.sync="dialogVisible" width="85%" :before-close="handleClose">
        ...
        <el-table ref="multipleTable" :data="gridData" border tooltip-effect="dark" :header-cell-style="{background:'#D7D7D7',color:'#666666'}" style="font-size:12px;width: 95%;margin-left:30px;margin-top:15px" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="a9" label="入库时间" width="106"></el-table-column>
          <el-table-column prop="a10" label="借入数量" width="104"></el-table-column>
        </el-table><br>
        <p style="margin-left:30px">预计归还时间：2017-11-26</p><br>
