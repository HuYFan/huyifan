<template>
  <div id="all">
    <Header></Header>
    <span class="sp1">审批管理>易耗品相关审批</span>
    <div class="div1">
      <span class="sp2">易耗品相关审批记录</span>
      <img src="../../assets/ly.png" style="margin-left:32px">
      ...
      <el-button type="text" @click="dialogVisible1 = true" style="color:#606266;position:absolute;top:310px;left:1171px;z-index:100;opacity:0">拒绝</el-button>
      ...
      <template>
        <el-table ref="multipleTable" :data="tableData" border tooltip-effect="dark" :header-cell-style="{background:'#D7D7D7',color:'#666666'}" style="width: 95%;margin-left:34px;margin-top:15px" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="a6" label="上一级" width="224"></el-table-column>
          <el-table-column prop="a7" label="操作" width="258"></el-table-column>
        </el-table>
      </template>
      <el-button type="text" @click="dialogVisible = true" style="color:#606266;position:absolute;top:310px;left:1089px;opacity:0">查看详情</el-button>
      <el-dialog title="领用申请详情" :visible.sync="dialogVisible" width="85%" :before-close="handleClose">
